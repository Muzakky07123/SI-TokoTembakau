                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col mr-2">
                                           ...
                                           <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?=$pendapatan['total']?></div>
                                       </div>
                                       <div class="col-auto">
                                   ...
                                   <div class="row no-gutters align-items-center">
                                       <div class="col mr-2">
                                           <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                               Pesanan Yang Diproses</div>
                                           <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$pesanan_pending['pending']?></div>
                                       </div>
                                       <div class="col-auto">
